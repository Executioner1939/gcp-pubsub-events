...
class TestIntegrationWithEmulator:
    ...
    def test_basic_message_flow(self, pubsub_client, pubsub_publisher, test_topic, 
                               test_subscription, test_listener, run_client, wait_for):
    ...
    def test_multiple_messages(self, pubsub_client, pubsub_publisher, test_topic,
                              test_subscription, test_listener, run_client, wait_for):
    ...
    def test_validation_error_handling(self, pubsub_client, pubsub_publisher, test_topic,
                                     test_subscription, test_listener, run_client, wait_for):
    ...
    def test_async_handler(self, pubsub_client, pubsub_publisher, test_topic,
                          test_subscription, test_listener, run_client, wait_for):
    ...
    def test_error_in_handler(self, pubsub_client, pubsub_publisher, test_topic,
                             test_subscription, test_listener, run_client, wait_for):
